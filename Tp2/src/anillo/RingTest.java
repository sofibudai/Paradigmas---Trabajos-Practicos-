...
public class RingTest {
    ...
    @Test
    void test05CurrentAndNextAfterTwoAdds() {
    ...
    @Test
    void test07InsertsAfterTwoAdds() {
    ...
    @Test
    void test08NextOnInsertsAfterTwoAdds() {
        assertEquals("Hola", new Ring().add("Hola")
                .add(new Integer(42))
                .next()
                .add(LocalDate.now())
    ...
    @Test
    void test09CyclesOnTreeElements() {
        assertEquals(LocalDate.now(), new Ring().add("Hola")
                .add(new Integer(42))
                .add(LocalDate.now())
                .next()
